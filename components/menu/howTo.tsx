  ...
  return (
    <MenuPage>
      ...
      <div className="how-to-section pb-2">
        ...
        <p>
          Found words are saved allowing you to return to the game throughout
          the day.
        </p>
      ...
      <div className="how-to-section">
        ...
        <p>
          Each puzzle contains at least one pangram, which is a word using each
          letter at least once. These are worth an additional 7 points.
        </p>
      </div>
    </MenuPage>
  );
